...
public class RenameColumnProcessingNodeTest {
    ...
    RenameColumnProcessingNode node = new RenameColumnProcessingNode(
            "testId",
            "processing",
            "rename_column",
            "col1",
    ...
    @Test
    public void shouldReturnResultOfRenameColumnProcessingIfCorrectNumberOfDataElementsIsCorrect() {
        when(csvData.size()).thenReturn(1);

        try (
                MockedStatic<RenameColumnProcessor> renameColumnProcessorMockedStatic = Mockito.mockStatic(RenameColumnProcessor.class);
            ...
            columnNameServiceMockedStatic
                    .when(() -> ColumnNameService.validateColumnName("col2"))
                    .thenReturn("col2");

            renameColumnProcessorMockedStatic
                    .when(() -> RenameColumnProcessor.renameColumn(input, "test.col1", "col2"))
                    .thenReturn(csv);
