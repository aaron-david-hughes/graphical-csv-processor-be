...
public class MergeRowsProcessingNodeTest {
    ...
    MergeRowsProcessingNode node = new MergeRowsProcessingNode(
            "testId",
            "processing",
            "merge_rows",
            "col",
    ...
    @Test
    public void shouldReturnResultOfMergeRowsProcessingIfCorrectNumberOfDataElementsIsCorrect() {
        when(csvData.size()).thenReturn(1);

        try (
                MockedStatic<MergeRowsProcessor> mergeRowsProcessorMockedStatic = Mockito.mockStatic(MergeRowsProcessor.class);
            ...
            mergeRowsProcessorMockedStatic
                    .when(() -> MergeRowsProcessor.mergeRow(input, "test.col", "val"))
                    .thenReturn(csv);
