...
public class AliasProcessingNodeTest {
    ...
    AliasProcessingNode node = new AliasProcessingNode("testId", "processing", "alias", "test");
    ...
    @Test
    public void shouldReturnResultOfAliasProcessingIfCorrectNumberOfDataElementsIsCorrect() {
        ...
        try (
            ...
            columnNameServiceMockedStatic
                    .when(() -> ColumnNameService.validateAlias("test"))
                    .thenReturn("test");

            aliasProcessorMockedStatic
                    .when(() -> AliasProcessor.alias(input, "test"))
                    .thenReturn(csv);
